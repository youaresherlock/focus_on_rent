"""
Django settings for focus_on_rent project.
...
SECRET_KEY = 'fq4@fm0z(v2l971gc$2lsi^=95)k4w2blwki)%&&)@=jk^%9v+'
...
WSGI_APPLICATION = 'focus_on_rent.wsgi.application'
...
QINIU_ADDRESS = 'https://qdpjw3zve.bkt.clouddn.com/'
